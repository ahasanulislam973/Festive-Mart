...
@section('main')
@section('title')
    {{ $breadsubcat->category->category_name }} > {{ $breadsubcat->subcategory_name }} | Fastive Mart - Online Vape Shop -
    Vape Mods, Kits &amp; E-Liquid
@endsection
<!-- ##############################  Title ##############################  -->
...
<div class="bredcrumbWrap">
    <div class="container breadcrumbs">
        ...
        <b>
            ...
            <span>{{ $breadsubcat->category->category_name }}</span>
        </b>
        <b>
            <span aria-hidden="true">›</span>
            <span>{{ $breadsubcat->subcategory_name }}</span>
        </b>
    </div>
</div>
<!--End Breadcrumb-->
