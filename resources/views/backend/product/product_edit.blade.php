                            ...
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="text-editor" name="long_descp">{!! $products->long_descp !!}</textarea>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="flexCheckDefault">Trending</label>
                                                    </div>
                                                </div>

                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="new_arrivals"
                                                            type="checkbox" value="1" id="flexCheckDefault"
                                                            {{ $products->new_arrivals == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="best_sellers"
                                                            type="checkbox" value="1" id="flexCheckDefault"
                                                            {{ $products->best_sellers == 1 ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="flexCheckDefault">Best
                                                            Sellers</label>
                                                    </div>
                                                </div>
